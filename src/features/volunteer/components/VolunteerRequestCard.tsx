        ...
        <CardContent className="p-6">
          <div className="flex justify-between items-start mb-5">
            <div className="flex items-center gap-4">
              <img 
                src={requesterAvatar || generateAvatarFallback(requesterName)} 
                alt={requesterName} 
              ...
              <div>
                ...
                <p className="text-base font-medium text-primary bg-primary/5 px-2 py-0.5 rounded-md inline-block mt-1 capitalize">{request.category}</p>
              </div>
            </div>
            {isHighPriority && (
              <span className="flex items-center gap-1.5 text-base font-bold text-red-700 bg-red-50 px-2.5 py-1 rounded-full border border-red-100 uppercase tracking-wider">
          ...
          <div className="flex flex-wrap gap-5 text-base text-stone-500 mb-6 font-medium">
